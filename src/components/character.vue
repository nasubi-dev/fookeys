...
<template>
  <div class="overCard animate-rotate-y animate-once animate-delay-100" :class="p.status === 'my' ? `left-2` : `left-2 top-5`">
    <img v-if="characterName" :src="`/img/characters/${characterName}/${reactionImg}.png`" class="scale-150" />
    <div
      v-if="retainedDef"
      class="fixed top-2/3 font-bold text-5xl text-border text-red-500"
